...
<head>
    ...
    <meta charset="UTF-8">
    <title>Kegiatan Anggota Remaja Masjid</title>
...
<body>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal"
                                        class="btn btn-info col-md-2"><span
                                            class="glyphicon glyphicon-plus"></span>Tambah Kegiatan Baru</button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary" value="Submit" name="kegiatanbaru">
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- Ganti dengan path Bootstrap Anda -->
    <script>
    $(document).ready(function() {
                $('input').on('keydown', function(event) {
                    if (this.selectionStart == 0 && event.keyCode >= 65 && event
                        .keyCode <=
                        90 && !(
                            event
                            .shiftKey) && !(event.ctrlKey) && !(event.metaKey) && !(
                            event
                            .altKey)) {
                        var $t = $(this);
