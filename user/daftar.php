                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        Selamat datang di Pendaftaran Remaja Masjid Agung Nurul Islam Singkawang
                                        Online.
                                        <br>- ECHO
                                        <br><br>
                                        Panduan Pendaftaran:
                                        ...
                                        PDF
                                        <br>
                                        <br>*Note: Pihak Ketua Remaja Masjid baru akan menerima data Anda setelah Anda
                                        klik
                                        'Confirm'
                                    </div>
                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nisn" type="text" class="form-control"
                                                            placeholder="Golongan darah" maxlength="12" required>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nik" type="text" class="form-control"
                                                            placeholder="Motivasi Bergabung" maxlength="255" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="ayahnik" type="text" class="form-control"
                                                            placeholder="Usia Ayah" maxlength="16">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="ibunik" type="text" class="form-control"
                                                            placeholder="Usia Ibu" maxlength="16">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="walinik" type="text" class="form-control"
                                                            placeholder="Usia Wali" maxlength="16">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="sekolahnpsn" type="text" class="form-control"
                                                            placeholder="isi dengan (TIDAK) Jika tidak pernah "
                                                            maxlength="12">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="sekolahnama" type="text" class="form-control"
                                                            placeholder="Isi Dengan Jujur!" maxlength="40">
                                                    </div>
                                                </div>
                                            </div>
