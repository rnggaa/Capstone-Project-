                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2>Tolong Di CEK kembali Datanya Sebelum Di Sumbit!</h2>
                                </div>
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        Remaja Masjid Agung Nurul Islam Singkawang
                                        <br>- 2024
                                        <br><br>
                                        Panduan Pendaftaran:
                                    ...
                                    <div class="market-status-table mt-4">
                                        <div class="table-responsive" style="overflow-x:hidden;">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label for="foto" class=" form-control-label">Pas Foto
                                                            3x4</label>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label for="scanijazahdepan" class=" form-control-label">Foto
                                                            1</label>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label for="scanijazahbelakang" class=" form-control-label">Foto
                                                            2</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-success" data-toggle="modal"
                                                    data-target="#myModal">Konfirmasi</button>
                                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post">
                            ...
                            <div class="modal-body">
                                Apakah Anda yakin untuk konfirmasi data Anda? Setelah dikonfirmasi, data tidak dapat
                                diubah kembali.
                                <input type="hidden" value="<?= $userid; ?>" name="id">
                            </div>
